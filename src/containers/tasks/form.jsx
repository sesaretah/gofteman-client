        ...
        <li>
          <div class="item-content item-input">
            <div class="item-inner">
              ...
              <div class="item-input-wrap">
                <input type="text" placeholder={dict.select_a_time} readonly="readonly" id="start-time-picker" />
              </div>
            </div>
          </div>
        </li>
        ...
        <li>
          <div class="item-content item-input">
            <div class="item-inner">
              ...
              <div class="item-input-wrap">
                <input type="text" placeholder={dict.select_a_time} readonly="readonly" id="deadline-time-picker" />
              </div>
            </div>
          </div>
        </li>
